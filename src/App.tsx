...
export default function App() {
  ...
  const handleUpdateSchool = async (id: number, data: { name: string; address: string; phone?: string; officialName?: string | null; abbreviation?: string | null; motto?: string | null; postalBox?: string | null; email?: string | null; city?: string | null; region?: string | null; educationDirection?: string | null; ministryName?: string | null; classNames?: string[]; subjectNames?: string[] }) => {
    try {
